...
% === NEW === check that the assign(N, T, D) is compatible with the requirements of the nurses
:- assign(N, T, D), impossible(N, T, D).
...
:- not assign(N,4,D+2), assign(N,3,D), assign(N,3,D+1).
